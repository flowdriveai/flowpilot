...
public class Draw {
    ...
    public static INDArray[] getLaneCameraFrame(ArrayList<float[]> lane, INDArray K, INDArray Rt, float width) {
        ...
        INDArray X = Nd4j.create(lane.get(1), 1, CommonModelF2.TRAJECTORY_SIZE);
        INDArray Y = Nd4j.create(lane.get(2), 1, CommonModelF2.TRAJECTORY_SIZE);
        INDArray Z = Nd4j.create(lane.get(0), 1, CommonModelF2.TRAJECTORY_SIZE);
        INDArray W = Nd4j.ones(1, CommonModelF2.TRAJECTORY_SIZE);
